...
@Serializable
data class GitLab(
  @SerialName("mr") val mergeRequest: GitLabMergeRequest,
...
@Serializable data class GitLabUserMergeData(@SerialName("can_merge") val canMerge: Boolean)

@Serializable
data class GitLabMergeRequest(
  @SerialName("allow_collaboration") val allowCollaboration: Boolean = false,
  @SerialName("allow_maintainer_to_push") val allowMaintainerToPush: Boolean = false,
  @SerialName("approvals_before_merge") val approvalsBeforeMerge: Int? = 0,
  val assignee: GitLabUser? = null,
  val author: GitLabUser,
  @SerialName("changes_count") val changesCount: String,
  @SerialName("closed_at") val closedAt: Instant? = null,
  @SerialName("closed_by") val closedBy: GitLabUser? = null,
  val description: String? = null,
  @SerialName("diff_refs") val diffRefs: GitLabDiffRefs,
  val downvotes: Int,
  @SerialName("first_deployed_to_production_at") val firstDeployedToProductionAt: Instant? = null,
  @SerialName("force_remove_source_branch") val forceRemoveSourceBranch: Boolean? = null,
  val id: Int,
  val iid: Int,
  @SerialName("latest_build_finished_at") val latestBuildFinishedAt: Instant? = null,
  @SerialName("latest_build_started_at") val latestBuildStartedAt: Instant? = null,
  val labels: List<String>,
  @SerialName("merge_commit_sha") val mergeCommitSha: String? = null,
  @SerialName("merged_at") val mergedAt: Instant? = null,
  @SerialName("merged_by") val mergedBy: GitLabUser? = null,
  @SerialName("merge_when_pipeline_succeeds") val mergeOnPipelineSuccess: Boolean,
  val milestone: GitLabMilestone? = null,
  @SerialName("head_pipeline") val pipeline: GitLabPipeline,
  @SerialName("project_id") val projectId: String,
  val sha: String,
  @SerialName("should_remove_source_branch") val shouldRemoveSourceBranch: Boolean? = false,
  @SerialName("source_branch") val sourceBranch: String,
  @SerialName("source_project_id") val sourceProjectId: String,
  val state: GitLabMergeRequestState,
  val subscribed: Boolean,
  @SerialName("target_branch") val targetBranch: String,
  @SerialName("target_project_id") val targetProjectId: String,
  val timeStats: GitLabMergeRequestTimeStats? = null,
  val title: String,
  val upvotes: Int,
  @SerialName("user") private val userMergeData: GitLabUserMergeData,
...
data class GitLabMergeRequestTimeStats(
  @SerialName("human_time_estimate") val humanTimeEstimate: Int = 0,
  @SerialName("human_time_spent") val humanTimeSpent: Int = 0,
  @SerialName("time_estimate") val timeEstimate: Int,
  @SerialName("total_time_spent") val totalTimeSpent: Int,
)

@Serializable data class GitLabMetadata(val pullRequestID: String, val repoSlug: String)
