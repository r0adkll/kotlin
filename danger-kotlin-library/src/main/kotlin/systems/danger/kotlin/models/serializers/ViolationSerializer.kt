...
object ViolationSerializer : KSerializer<Violation> {
  override val descriptor: SerialDescriptor
    get() =
      buildClassSerialDescriptor("systems.danger.kotlin.sdk.Violation") {
  ...
  override fun serialize(encoder: Encoder, value: Violation) {
    encoder.encodeStructure(descriptor) {
      ...
      value.file?.let { encodeStringElement(descriptor, 1, it) }
      value.line?.let { encodeIntElement(descriptor, 2, it) }
    }
  }
}
