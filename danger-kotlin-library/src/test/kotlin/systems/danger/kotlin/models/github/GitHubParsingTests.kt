...
class GitHubParsingTests {
    ...
    with(github.pullRequest) {
      ...
      val expectedHead =
        GitHubMergeRef(
          "artsy:xcode-update",
          "xcode-update",
          "d769f276e066d79169a8bfa5795c8a4853f942f3",
          artsyUser,
          eidolonRepo,
        )
  ...
  fun testItParsesCorrectlyTheCommits() {
    ...
    val expectedGitAuthor =
      GitCommitAuthor("Ash Furrow", "ash@ashfurrow.com", "2016-07-26T19:54:16Z")
    val expectedGitCommitter =
      GitCommitAuthor("Ash Furrow", "ash@ashfurrow.com", "2016-07-26T19:55:00Z")
    val expectedCommit =
      GitCommit(
        null,
        expectedGitAuthor,
  ...
  fun testItParsesTheClosedMilestone() {
    ...
    with(github.issue.milestone!!) { assertEquals(GitHubMilestoneState.CLOSED, state) }
  }
