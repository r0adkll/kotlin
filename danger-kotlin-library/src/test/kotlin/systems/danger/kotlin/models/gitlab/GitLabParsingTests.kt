...
class GitLabParsingTests {
  ...
  fun testItParsesTheGitLabMergeRequest() {
    with(gitLab.mergeRequest) {
      ...
      val orta =
        GitLabUser(
          "https://secure.gravatar.com/avatar/f116cb3be23153ec08b94e8bd4dbcfeb?s=80&d=identicon",
          377669,
          "Orta",
          GitLabUserState.ACTIVE,
          "orta",
          "https://gitlab.com/orta",
        )
      ...
      assertEquals(
        "Updating it to avoid problems like https://github.com/danger/swift/issues/221",
        description,
      )
      val expectedDiffRefs =
        GitLabDiffRefs(
