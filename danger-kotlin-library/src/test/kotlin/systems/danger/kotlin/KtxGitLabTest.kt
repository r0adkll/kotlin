...
internal class GitLabKtxTest {
  ...
  companion object {
    ...
    private const val diffUrl =
      "$projectUrl/merge_requests/182/diffs#diff-content-6b0f4e17f37f5ea51f169e6e1eaa04a0151b17d1"
    private const val blobUrl =
      "$projectUrl/blob/621bc3348549e51c5bd6ea9f094913e9e4667c7b/$filePath"
  }
  ...
  @Test fun testProjectUrlAreCorrect() = assertEquals(projectUrl, gitLab.projectUrl)

  @Test fun testWebUrlAreCorrect() = assertEquals(blobUrl, gitLab.toWebUrl(filePath))
