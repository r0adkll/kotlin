...
A dedicated [Run UI Tests](../../../Downloads/intellij-platform-plugin-template-main/.github/workflows/run-ui-tests.yml) workflow is available for manual triggering to run UI tests against three different operating systems: macOS, Windows, and Linux.
Due to its optional nature, this workflow isn't set as an automatic one, but this can be easily achieved by changing the `on` trigger event, like in the [Build](../../../Downloads/intellij-platform-plugin-template-main/.github/workflows/build.yml) workflow file.
...
- using the [Qodana IntelliJ GitHub Action][jb:qodana-github-action], run automatically within the [Build](../../../Downloads/intellij-platform-plugin-template-main/.github/workflows/build.yml) workflow,
...
- [Build](../../../Downloads/intellij-platform-plugin-template-main/.github/workflows/build.yml)
...
- [Release](../../../Downloads/intellij-platform-plugin-template-main/.github/workflows/release.yml)
...
- [Run UI Tests](../../../Downloads/intellij-platform-plugin-template-main/.github/workflows/run-ui-tests.yml)
  - Triggered manually.
  - Runs for macOS, Windows, and Linux separately.
  - Runs `runIdeForUiTests` and `test` Gradle tasks.
- [Template Cleanup](../../../Downloads/intellij-platform-plugin-template-main/.github/workflows/template-cleanup.yml)
